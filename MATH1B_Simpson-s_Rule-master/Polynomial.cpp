    ...
    else
    {
        for (int i=1; i<=temp.get_size(); ++i)
        {
            ...
            if(i==temp.get_size())
            {
                ...
                cout << temp.get_current().getCoefficient();
                // << temp.get_current().getExponent();
                
            }
            
            else if(i==temp.get_size()-1)
            {
                if(temp.get_current().getCoefficient() == 0)
                {}
                else
                {
...
Polynomial Polynomial::derivative()
{
    ...
    else
    {
        for (int i=1; i<=temp.get_size(); ++i)
        {
            ...
            exponent = temp.get_current().getExponent();
            coefficient = temp.get_current().getCoefficient();
            ...
            if(exponent == -1)
                ...
                result.insertTerm(exponent, coefficient);
        }
    }
