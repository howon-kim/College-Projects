/*------------------------------------------------------------------------------------------
 ...
 Description:
 This header file is for Class object
 Class object stores every data about classes
 such as crn, subject, course, section, title, status, days, time, room, campus, units, instructor, seats
